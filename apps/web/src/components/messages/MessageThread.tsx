...
export function MessageThread({
  ...
  return (
    <div className="space-y-4">
      {messages.length === 0 ? (
        <div className="flex flex-col items-center gap-2 rounded-xl border border-dashed border-gris-light bg-surface px-6 py-10 text-center">
                        ...
                        <div
                          className={`inline-block rounded-2xl border px-4 py-2.5 text-left ${
                            mine
                              ...
                              : "rounded-tl-sm border-gris-light bg-surface"
                          }`}
                        >
